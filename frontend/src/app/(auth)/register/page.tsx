    ...
    <div className="h-screen flex flex-col lg:flex-row bg-card overflow-hidden">
      ...
      <div className="hidden lg:flex w-full lg:w-5/12 bg-[#1A1B4B] text-white p-12 flex-col justify-between relative">
        ...
        <div className="relative z-10 border-t border-white/10 pt-6">
          <div className="flex items-center gap-6 text-xs font-semibold tracking-widest uppercase text-muted-foreground">
            <span>Optimized</span>
      ...
      <div className="flex-1 flex items-center justify-center bg-muted p-4 overflow-y-auto">
