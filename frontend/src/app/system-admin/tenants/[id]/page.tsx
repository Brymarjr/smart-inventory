...
export default function TenantDetailPage({
  ...
  const handleToggleStatus = async () => {
    ...
    try {
      ...
      setTenant((prev) =>
        prev ? { ...prev, is_active: data.is_active } : null,
      );
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <div className="flex justify-between border-b pb-2">
              ...
              <span className="font-medium">
                {tenant.settings?.store_name || tenant.name}
              </span>
            </div>
            <div className="flex justify-between border-b py-2">
              <span className="text-muted-foreground">Currency</span>
              <span className="font-medium">
                {tenant.settings?.currency_symbol || "N/A"}
              </span>
            </div>
            <div className="flex justify-between pt-2">
              <span className="text-muted-foreground">Address</span>
              <span className="font-medium truncate max-w-[200px]">
                {tenant.settings?.store_address || "No address set"}
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <TabsContent value="activity" className="pt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Actions performed by users in this organization.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {logsLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-10 text-muted-foreground bg-muted rounded-lg border border-dashed">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Manage subscription status and validity.
                </CardDescription>
              </div>
              {subscription && (
                  ...
                  <DialogContent>
                    ...
                    <div className="py-4">
                      ...
                      <p className="text-sm text-muted-foreground mt-2">
                        This will push the expiration date forward by the
          ...
          <Card>
            ...
            <CardContent>
              {transactions.length === 0 ? (
                <div className="text-center text-muted-foreground py-8 border border-dashed rounded-lg bg-muted">
