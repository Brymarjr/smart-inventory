  ...
  const handleTriggerTraining = async () => {
    ...
    try {
      ...
      toast.error("Training Failed", {
        description: "Could not contact the ML service.",
      });
    } finally {
      setIsTraining(false);
    }
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Global performance across all organizations.
        </p>
      </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center">
                <span className="relative flex h-2 w-2 mr-2">
                  <span
                    className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 ${analytics?.health.database === "Online" ? "bg-green-400" : "bg-red-400"}`}
                  ></span>
                  <span
                    className={`relative inline-flex rounded-full h-2 w-2 ${getHealthColor(analytics?.health.database || "Offline")}`}
                  ></span>
                </span>
                ...
                <div
                  className={`ml-auto font-medium ${getHealthText(analytics?.health.database || "Offline")}`}
                >
              ...
              <div className="flex items-center">
                <span
                  className={`flex h-2 w-2 rounded-full mr-2 ${getHealthColor(analytics?.health.redis || "Offline")}`}
                ></span>
                <div className="ml-4 space-y-1">
                ...
                <div
                  className={`ml-auto font-medium ${getHealthText(analytics?.health.redis || "Offline")}`}
                >
              ...
              <div className="flex items-center">
                <span
                  className={`flex h-2 w-2 rounded-full mr-2 ${getHealthColor(analytics?.health.api || "Offline")}`}
                ></span>
                <div className="ml-4 space-y-1">
                ...
                <div
                  className={`ml-auto font-medium ${getHealthText(analytics?.health.api || "Offline")}`}
                >
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <CardDescription>
                  Manually trigger retraining for Demand Forecasting models
                  across all tenants.
                </CardDescription>
              </div>
              <div className="flex items-center gap-4">
                {lastTrained && (
                  <span className="text-xs text-muted-foreground flex items-center bg-card px-2 py-1 rounded border">
      ...
      <div className="pt-4">
        <h2 className="text-2xl font-bold tracking-tight text-foreground dark:text-white mb-4">
