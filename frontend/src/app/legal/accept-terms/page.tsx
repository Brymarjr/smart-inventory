  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 dark:bg-gray-900">
      <Card className="w-full max-w-3xl shadow-xl border-t-4 border-t-blue-600">
        ...
        <CardContent>
          <ScrollArea className="h-[400px] w-full rounded-md border p-6 bg-card text-sm leading-relaxed text-gray-700 shadow-inner dark:bg-gray-800 dark:text-gray-300">
            <div className="space-y-6">
              <section>
                <h3 className="font-bold mb-2 text-gray-900 dark:text-white text-base">
                  1. Acceptance of Terms
                </h3>
                <p>
                  By accessing, logging into, or utilizing the FORETRACK
                  platform, you acknowledge that you have read, understood, and
                  agree to be bound by these Terms and Conditions. If you do not
                  agree with any part of these terms, you must discontinue use
              ...
              <section>
                ...
                <p>
                  Access is granted strictly to authorized personnel. You are
                  solely responsible for safeguarding your authentication
                  credentials. Sharing accounts, passwords, or attempting to
                  bypass platform security controls is strictly prohibited and
              ...
              <section>
                ...
                <p>
                  ...
                  business interruptions resulting from user error, hardware
                  failure, or network latency.
                </p>
              </section>
