    ...
    <div className="h-screen w-full flex flex-col lg:flex-row bg-card overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 max-w-md">
              <p className="text-slate-400 text-xl leading-relaxed max-w-sm font-light">
                Regain access to your optimized inventory workspace quickly and
                securely.
              </p>
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-slate-50 p-4 overflow-y-auto w-full">
        <Card className="w-full max-w-3xl border-none shadow-[0_20px_60px_rgba(0,0,0,0.12)] rounded-[2.5rem] p-4 lg:p-10 bg-card my-4">
            ...
            {isSubmitted ? (
              ...
              <div className="flex flex-col items-center justify-center space-y-6 py-8 text-center bg-slate-50 rounded-3xl border-2 border-slate-100 p-8">
                ...
                <div className="space-y-3 max-w-md">
                  <h3 className="font-black text-2xl text-[#1A1B4B]">
                    Check your email
                  </h3>
                  <p className="text-base text-slate-500 font-medium leading-relaxed">
                    If an account exists for{" "}
                    <strong className="text-[#2D31FA]">{email}</strong>, we have
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Label
                    htmlFor="email"
                    className="text-[#2D31FA] text-lg font-black"
                  >
                    Registered Email
                  </Label>
                  <Input
          ...
          {!isSubmitted && (
            <CardFooter className="flex justify-center border-t border-slate-100 mt-6 pt-6"></CardFooter>
          )}
        </Card>
      </div>
    </div>
