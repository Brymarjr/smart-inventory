    ...
    try {
      ...
      if (error.response?.status === 403) {
        toast.error("Premium Feature", {
          description: "Upgrading is required to export logs.",
        });
      } else {
        console.error(error);
    ...
    return (
      <div className="p-6">
        <PremiumPaywall
          ...
          message={
            data.message ||
            "Track every user action, product update, and system change with immutable audit logs. Upgrade to unlock."
          }
        />
      </div>
    );
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Track critical actions performed by staff.
          </p>
        </div>
