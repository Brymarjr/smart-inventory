...
import { DollarSign, TrendingUp, Package, AlertTriangle, ArrowUpRight } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-3xl font-bold tracking-tight">Dashboard</h1>
      <p className="text-muted-foreground">Overview of Business.</p></div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-4">
            <CardHeader className="grid grid-cols-[1fr_auto] items-center gap-y-1.5 bg-slate-50/50 border-b border-slate-100 p-6">
                ...
                <div className="col-start-2 row-span-2 row-start-1 flex items-center justify-center p-2 bg-white rounded-lg border border-slate-200 shadow-sm">
